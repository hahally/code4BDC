...
class Config():
    ...
    vocab_path = './pretrain_model/ngram_mlm_seq2seq/vocab.txt'
    model_path = './saved_models/bart-base-copy-fgm' # './pretrain_model/ngram_mlm_seq2seq'
    checkpoint = None
    save_model_path = './saved_models/bart-base-copy-fgm'
...
def build_optim(config, model):
    ...
    optimizer_parameters = [
        ...
        {'params':[p for n,p in params if not any(nd in n for nd in other) and any(nd in n for nd in no_decay) ],'weight_decay':0,'lr':5e-5},
